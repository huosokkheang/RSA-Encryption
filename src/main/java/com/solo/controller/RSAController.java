...
import com.RSA.key.RSA;
import com.RSA.key.RSAKeyPairGenerator;
...
public class RSAController {
	...
	public static void main(String[] args) throws Exception {  
		...
		String encrypt = RSA.encryption("hello", publicKey);
		System.out.println("encrypt text : " + encrypt);
		String decrypt = RSA.decryption(encrypt, privateKey);
